=MongoDB Ruby Driver Koans - larryprice fork

Editor: Larry Price <larry.price.dev@gmail.com>

This is a forked repo of an updated MongoDB Ruby Driver Koans, which is in turn a fork of the original repo.

This fork is specifically updated to work better with:
* Ruby 1.9.3
* MongoDB Ruby Driver 1.8 or later

To check your MongoDB Ruby Driver run the following command:

# gem list | grep mongo

Based on https://github.com/tredfern/MongoDB_Koans which is based on http://github.com/edgecase/ruby_koans
...
Any response for Ruby with a version number greater than 1.9.2 is fine (should be 
around 1.9.3 or more). Any version of rake will do.
